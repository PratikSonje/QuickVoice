    ...
    return (
      <div className="flex min-h-screen items-center justify-center p-6">
        <div className="w-full max-w-md rounded-2xl border bg-card p-8 text-center">
          <div className="mx-auto mb-5 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-primary/30 to-primary/5 text-primary">
        ...
        {organizations.map((org) => {
          ...
          return (
            <button
              ...
              disabled={!!pendingId}
              className="group relative flex flex-col gap-4 overflow-hidden rounded-2xl border bg-card p-5 text-left transition-all hover:border-primary/40 hover:shadow-md disabled:opacity-60"
            >
              <div
                aria-hidden
                className="pointer-events-none absolute -right-8 -top-8 size-28 rounded-full bg-gradient-to-br from-primary/20 to-transparent opacity-0 blur-2xl transition-opacity group-hover:opacity-100"
              />
